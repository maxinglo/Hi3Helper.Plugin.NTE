...
{
    static Exports() => Load<WuwaPlugin>(!RuntimeFeature.IsDynamicCodeCompiled ? new Core.Management.GameVersion(0, 6, 2, 0) : default); // Loads the IPlugin instance as WuwaPlugin.
